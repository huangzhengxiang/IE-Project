...
if __name__== "__main__":
    ...
    ckpt_dir="./long-tune/{}_{}_{}_best.pth".format(dataset,model_name,language)
    ...
    # scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer=optimizer,milestones=[1],gamma=0.02) # change
    ...
    for i in range(nepoch):
        ...
        if (v_loss < best_loss):
            ...
            if tuning and language=="cn":
                embed.save_pretrained("./long-tune/chinese-roberta-wwm-ext-large")
            elif tuning and language=="en":
                embed.save_pretrained("./long-tune/bert-large-uncased")
